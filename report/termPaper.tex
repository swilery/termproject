...
\node[v]	(dotS)  					   		{$\bullet{S}$};
\node[v] 	(dotN)  	[below = of dotS]		{$\bullet{N}$};
\node[v] 	(dottt)  	[below = of dotN]		{$N\longrightarrow{\bullet{tt}}$};
\node[v] 	(tdott)  	[below = of dottt]		{$N\longrightarrow{t\bullet{t}}$};
\node[v] 	(ttdot)  	[below = of tdott]		{$N\longrightarrow{tt\bullet}$};
\node[v] 	(Ndot)  	[below = of ttdot]		{$N\bullet$};
\node[v] 	(Sdot)  	[below = of Ndot]		{$S\bullet$};
\node[v] 	(dotNt)		[left = of dotN]		{$S\longrightarrow{\bullet{Nt}}$};
\node[v] 	(Ndott)  	[below = of dotNt]		{$S\longrightarrow{N\bullet{t}}$};
\node[v] 	(Ntdot)  	[below = of Ndott]		{$S\longrightarrow{Nt\bullet}$};
\node[v] 	(dottN)  	[right = of dotN]		{$S\longrightarrow{\bullet{tN}}$};
\node[v] 	(tdotN)  	[below = of dottN]		{$S\longrightarrow{t\bullet{N}}$};
\node[v] 	(tNdot)  	[below = of tdotN]		{$S\longrightarrow{tN\bullet}$};
\path(dotS)		edge	node			{}		(dotNt)
	 (dotS)		edge	node			{}		(dottN)
	 (dotNt)	edge	node			{}		(dotN)
	 (dottN)	edge	node			{}		(dotN)
	 (dotN)		edge	node			{}		(dottt)
	 (dottt)	edge	node[left]		{$t$}	(tdott)
	 (tdott)	edge	node[left]		{$t$}	(ttdot)
	 (ttdot)	edge	node			{}		(Ndot)
	 (Ndot)		edge	node			{}		(Ndott)
	 (Ndot)		edge	node			{}		(tNdot)
	 (Ndott)	edge	node[left]		{$t$}	(Ntdot)
	 (dottN)	edge	node[left]		{$t$}	(tdotN)
	 (Ntdot)	edge	node			{}		(Sdot)
	 (tNdot)	edge	node			{}		(Sdot);
\end{tikzpicture}
